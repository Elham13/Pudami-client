  ...
  return (
    <>
      {loading ? (
        ...
        <div className="w-full flex flex-col text-sm md:text-lg justify-center items-start space-y-3">
          ...
          <div className="w-full flex flex-col justify-center items-center space-y-3">
            <span className="w-36 h-36 md:w-40 md:h-40 bg-blue-400 rounded-full text-center text-6xl flex justify-center items-center mt-4 overflow-hidden">
              {/* {user.profile.img == "" ? (
                <>M</>
              ) : ( */}
              <img
          ...
          <div className="w-full ">
            ...
            >
              ...
              <button
                type="submit"
                className="bg-lime-500 py-2 px-4 border text-white hover:bg-white hover:text-lime-500 hover:border-lime-500"
              >
                Edit Profile
              </button>
            </form>
