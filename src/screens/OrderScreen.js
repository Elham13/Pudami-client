    ...
    <div className="container mx-auto text-sm md:text-lg flex flex-col justify-start items-center space-y-3 text-gray-600">
      ...
      <div className="container py-4 bg-gray-200 flex justify-between items-center">
        ...
        >
          ...
          {!show ? (
            <span className="text-lg md:text-xl ml-2 flex justify-center items-center">
              Show order summery
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6"
      ...
      <div className="w-full flex justify-start items-center">
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
          class="w-10 h-10 md:h-20 md:w-20 text-lime-500"
          viewBox="0 0 20 20"
          fill="currentColor"
        >
          <path
      ...
      <Link
        className="w-full flex justify-center items-center h-16 text-white md:text-lg font-semibold rounded-lg bg-lime-500 "
        to="/"
      >
        Continue shopping
      </Link>
